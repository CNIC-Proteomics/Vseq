...
args[1] <- "DdS"
args[2] <- "RH_Heart_TMTHF_FR7"
args[3] <- "D:/data/Ratones_Heteroplasmicos_HF/heart/data_for_vseq/"
args[4] <- "D:/data/Ratones_Heteroplasmicos_HF/heart/data_for_vseq/RH_Heart_TMTHF_FR7.dta/"
args[5] <- "D:/data/Ratones_Heteroplasmicos_HF/heart/vseq_graphs/RH_Heart_TMTHF_FR7/"
# args[1] <- "DiS"
# args[2] <- "b1948_293T_proteinID_12B_QE3_122212"
# args[3] <- "S:/U_Proteomica/UNIDAD/DatosCrudos/GyGy_Dataset/raws/"
# args[4] <- "S:/U_Proteomica/UNIDAD/DatosCrudos/GyGy_Dataset/raws/b1948_293T_proteinID_12B_QE3_122212.dta/"
# args[5] <- "D:/data/GyGy_Dataset/vseq_graphs/b1948_293T_proteinID_12B_QE3_122212/"
if ( length(args) < 6 ) {
  msg = paste0("\n",
               ...
               "D:\\data\\Ratones_Heteroplasmicos_HF\\muscle\\data_for_vseq\\RH_muscle_TMTHF_FR1.dta\\ ",
               "D:\\data\\Ratones_Heteroplasmicos_HF\\muscle\\vseq_graphs\\RH_muscle_TMTHF_FR1\\ ")
  stop(msg, call.=FALSE)
}
...
print(infile)
infile2 = paste0(datapath, experimento, ".filter.tsv") ##  datos del query SQL
sql <- read.csv(infile2, sep = "\t")
# infile2 = paste0("D:/data/GyGy_Dataset/", experimento, ".filter.csv")
sql <- read.csv(infile2)
...
# begin: jmrc
# system(paste("Rscript Vseq_launcher.R",inscans, inpathRgraphs))
