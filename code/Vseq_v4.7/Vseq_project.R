...
# begin: jmrc
if ( length(matches[,1]) > 0 && length(c_asign[,1]) > 0 ) {
...
# begin: jmrc
#varNamePath <- "D:\\data\\Ratones_Heteroplasmicos_HF\\muscle\\vseq_graphs\\"
